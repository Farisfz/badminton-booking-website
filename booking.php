...
<div class="container-fluid">
    <form action="" id="booking-form">
        ...
        <div class="form-group">
            <label for="date_from" class="control-label">Date</label>
            <input name="date_from" id="date_from" type="date" class="form-control form-control-sm rounded-0" required />
        </div>
        <div class="form-group">
            <label for="time" class="control-label">Time</label>
            <input name="date_to" id="date_to" type="time" class="form-control form-control-sm rounded-0" required />
        </div>
        <div class="form-group">
            <label for="date_to" class="control-label">Until</label>
            <input name="time_end" id="time_end" type="time" class="form-control form-control-sm rounded-0" required />
        </div>
    </form>
</div>
